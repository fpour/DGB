...
for i in range(N_RUNS):
    ...
    test_acc, test_ap, test_f1, test_auc, test_avg_measures_dict = eval_one_epoch_original(
    ...
    if args.mode == 'i':
        test_new_new_acc, test_new_new_ap, test_new_new_f1, test_new_new_auc, test_new_new_avg_measures_dict = \
            eval_one_epoch_original('test for {} nodes'.format(args.mode), cawn, test_rand_sampler, test_src_new_new_l,
        ...
        test_new_old_acc, test_new_old_ap, test_new_old_f1, test_new_old_auc, test_new_old_avg_measures_dict = \
            eval_one_epoch_original('test for {} nodes'.format(args.mode), cawn, test_rand_sampler,
